...
public class LedBeamActivity extends Activity implements CreateNdefMessageCallback {
    ...
    public void onCreate(Bundle savedState) {
        ...
        message = power.getText().toString();
